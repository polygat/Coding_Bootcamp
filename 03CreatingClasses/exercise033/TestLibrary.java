...
public class TestLibrary {
	...
	public static void useInterface () {
		while (true){
			...
			char num  = menu.next().charAt(0);
			
			switch (num) {
			case '1': Library.printAvailableBooks(); break;
			case '2': System.out.println("Give a book's title");
				Scanner aa = new Scanner(System.in);
				String a = aa.next();
				Library.printBookDetails(a);break;
			case '3': System.out.println("Give a book's author");
				Scanner bb = new Scanner(System.in);
				String b = bb.next();
				Library.printBookFromAuthor(b);break;
			case '4': Library.printTheMostPopularBook();break;
